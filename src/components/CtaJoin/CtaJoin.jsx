        ...
        <div className="bg-pri-blue py-16">
            <div className="container flex flex-col items-center gap-5">
                ...
                <div className="flex flex-col gap-4 lg:gap-8 w-full sm:flex-row sm:justify-center py-3">
                    ...
                    <button className="capitalize text-white-shade py-3.5 lg:py-4 px-8 cursor-pointer border-2 border-white-shade hover:bg-white-shade hover:text-pri-blue duration-200 rounded-lg self-stretch font-semibold lg:text-lg">
                        Schedule Demo
                    </button>
                </div>

                <p className="text-blue-100 text-sm relative -top-1.5 text-center">
