...
const Hero = () => {
    return (
        <section 
            className="w-full min-h-[calc(53vh-4rem)] 2xl:min-h-[calc(60vh-4rem)] flex items-center" 
            style={{
                backgroundImage: "linear-gradient(to bottom, #f8f8f8, rgba(17, 24, 39, 0.02))",
            }}
        >
            <div className="container flex flex-col md:flex-row md:items-center gap-8 py-12 lg:py-16">
